...
\hlkwd{canvas_collatz}\hldef{(}
  ...
  \hlkwc{angle.odd} \hldef{=} \hlopt{-}\hlnum{.05}\hldef{,}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{canvas_flame}\hldef{(}
  \hlkwc{colors} \hldef{=} \hlkwd{colorPalette}\hldef{(}\hlsng{"neo3"}\hldef{),}
  \hlkwc{background} \hldef{=} \hlsng{"#000000"}\hldef{,}
  \hlkwc{iterations} \hldef{=} \hlnum{1000000}\hldef{,}
  \hlkwc{variations} \hldef{=} \hlnum{21}\hldef{,}
  \hlkwc{symmetry} \hldef{=} \hlnum{3}\hldef{,}
  \hlkwc{blend} \hldef{=} \hlnum{TRUE}\hldef{,}
  \hlkwc{weighted} \hldef{=} \hlnum{FALSE}\hldef{,}
  \hlkwc{post} \hldef{=} \hlnum{FALSE}\hldef{,}
  \hlkwc{final} \hldef{=} \hlnum{FALSE}\hldef{,}
  \hlkwc{extra} \hldef{=} \hlnum{FALSE}\hldef{,}
  \hlkwc{display} \hldef{=} \hlkwd{c}\hldef{(}\hlsng{"colored"}\hldef{,} \hlsng{"logdensity"}\hldef{),}
  \hlkwc{zoom} \hldef{=} \hlnum{1.8}\hldef{,}
  \hlkwc{resolution} \hldef{=} \hlnum{1000}\hldef{,}
  \hlkwc{gamma} \hldef{=} \hlnum{1}
\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcom{#initial sequence}
\hldef{seq.1}\hlkwb{=}\hldef{(}\hlnum{0}\hlopt{:}\hlnum{10}\hldef{)}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcom{#sequence after algebra}
\hldef{seq.2} \hlkwb{=} \hlnum{2}\hlopt{^}\hldef{(seq.1}\hlopt{+}\hlnum{1}\hldef{)} \hlopt{+} \hlnum{2}\hlopt{^}\hldef{(seq.1}\hlopt{-}\hlnum{1}\hldef{)}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{which}\hldef{(seq.2} \hlopt{==} \hlnum{40}\hldef{)}
\end{alltt}
\begin{verbatim}
## [1] 5
\end{verbatim}
...
The number 84 will not be in the sequence of seq.2 so it cannot calcualte a result because it is not using algebra but simply looking for it in the sequence.  
