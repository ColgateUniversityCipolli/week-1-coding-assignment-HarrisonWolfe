...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
The number 84 will not be in the sequence of seq.2 so it cannot calcualte a result because it is not 
using algebra but simply looking for it in the sequence.  
\end{alltt}
\end{kframe}
\end{knitrout}
